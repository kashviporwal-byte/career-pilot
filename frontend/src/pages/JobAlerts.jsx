                    ...
                    {stats && (
                        <div className="grid grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={idx} className={`bg-neutral-900/50 border border-neutral-800 rounded-xl p-4 ${hoverBorderClassMap[stat.color] || 'hover:border-neutral-700'} transition-colors`}>
